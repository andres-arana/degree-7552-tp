...
public class Text extends JLabel implements Transferable, DragSourceListener, DragGestureListener {
	...
	private static final long serialVersionUID = 2731950933749664458L;
    ...
    public Text(String text){
	    ...
	    handler = new TransferHandler(){
			private static final long serialVersionUID = -4572320513220720965L;
	...
	public DataFlavor[] getTransferDataFlavors() {
		return new DataFlavor[]{new DataFlavor(Text.class, "Text")};
	}
