...
public abstract class ModeloParserXml extends ParserXML {
	...
	/**
	 * Busca un elemento con el id especificado y trata de parsearlo segun el
	 * tipo de elemento.
	 * 
	 * @param id
	 * @return
	...
	/**
	 * Parsea un elemento segun la implementacion de la instancia devuelta por
	 * mapElement.
	 * 
	 * @param element
	 * @return
