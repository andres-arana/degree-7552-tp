...
public class NewBehaviorDiagramRelationAction extends Action {
     ...
     */
    @Inject
    public NewBehaviorDiagramRelationAction(final ImageLoader imageLoader, SimpleDialogLauncher dialog) {
        this.dialog = dialog;
     ...
     */
    public NewBehaviorDiagramRelationAction boundTo(final BehaviorDiagram diagram) {
    ...
    public void run() {
        ...
        if(stringOptional.isPresent()){
            ...
            BehaviorRelation relation = new BehaviorRelation("Relation" + relationNumber, boundDiagram.getStateByName(initialStateName),boundDiagram.getStateByName(finalStateName));
            Representation<BehaviorRelation> representation = new Representation<>(relation);
