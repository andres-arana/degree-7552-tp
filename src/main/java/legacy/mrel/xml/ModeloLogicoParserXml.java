...
import legacy.mer.control.TablaControl;
import legacy.mer.modelo.Proyecto;
import legacy.mer.modelo.base.Componente;
import legacy.mer.xml.Constants;
import legacy.mer.xml.ModeloParserXml;
import legacy.mer.xml.XmlHelper;
import legacy.mer.xml.Xmlizable;
import legacy.mrel.modelo.DiagramaLogico;
import legacy.mrel.modelo.Tabla;
import legacy.mrel.modelo.Tabla.ClaveForanea;
