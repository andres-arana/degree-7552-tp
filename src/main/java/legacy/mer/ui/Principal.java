...
import legacy.mer.control.DiagramaControl;
import legacy.mer.control.DiagramaLogicoControl;
import legacy.mer.modelo.CurrentOpenProject;
import legacy.mer.modelo.Proyecto;
import legacy.mer.modelo.ProyectoProxy;
import legacy.mer.modelo.Validacion.EstadoValidacion;
import legacy.mer.modelo.base.Componente;
import legacy.mer.modelo.validacion.Observacion;
import legacy.mer.ui.builders.DialogBuilder;
import legacy.mer.ui.builders.MenuBuilder;
import legacy.mer.ui.builders.ToolBarBuilder;
import legacy.mer.ui.builders.TreeManager;
import legacy.mer.ui.builders.DialogBuilder.PromptResult;
import legacy.mer.ui.builders.DialogBuilder.Resultado;
import legacy.mer.ui.dialogs.AddEntityController;
import legacy.mer.ui.dialogs.AddHierarchyController;
import legacy.mer.ui.dialogs.AddRelationController;
import legacy.mer.ui.dialogs.SelectComponentController;
import legacy.mer.ui.figuras.DiagramaFigura;
import legacy.mer.ui.figuras.DiagramaLogicoFigura;
import legacy.mer.xml.SaverLoaderXML;
import legacy.mrel.conversor.ConversorDERRepresentacion;
import legacy.mrel.conversor.ConversorDERaLogico;
