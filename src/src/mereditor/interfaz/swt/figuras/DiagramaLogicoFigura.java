...
public class DiagramaLogicoFigura extends Figure implements FigureListener {
	...
	private DiagramaLogico diagrama;
	 ...
	 * @param diagrama
	 */
	public DiagramaLogicoFigura(FigureCanvas canvas, DiagramaLogico diagrama) {
	...
	public void actualizar() {
		this.removeAll();
		DiagramaLogicoControl diagrama = (DiagramaLogicoControl) this.diagrama;
